...
const LetterGlitch = ({
  ...
  return (
    <div
      className="relative w-full h-full bg-[#101010] overflow-hidden [mask-image:linear-gradient(to_right,rgba(0,0,0,0)_0%,rgba(0,0,0,1)_20%,rgba(0,0,0,1)_80%,rgba(0,0,0,0)_100%)]"
    >
